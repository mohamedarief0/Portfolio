...
function Skills() {
    return (
        <div>
            <h1 className="c-w">Skills</h1>
            <div className="c-g grid">
                ...
                <div className="skill-card">
                    ...
                    <h3>
                        <img src="./images/react-js-icon.svg" width="30" height="30" className="react" />
                        React.js
                    </h3>
                </div>
                ...
                <div className="skill-card">
                    <h1>DESIGN</h1>
                    <h3><img src="./images/figma-logo.svg" width="30" height="30" fill="currentColor" /> Figma</h3>
                    <h3><img src="./images/adobe-photoshop.svg" width="30" height="30" fill="currentColor" / > Photoshop</h3>
                </div>
